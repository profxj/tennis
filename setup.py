...
#
setup_keywords['name'] = 'tennis'
setup_keywords['description'] = 'Tennis Misc'
setup_keywords['author'] = 'X'
setup_keywords['author_email'] = 'xavier@ucolick.org'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/profxj/tennis'
#
